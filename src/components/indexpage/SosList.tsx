    ...
    <>
      ...
      <div className="bg-white p-4 rounded-md mt-8 shadow-sm overflow-x-auto">
        <table className="table-fixed min-w-[800px] w-full text-left">
          <thead className="text-gray70 text-[16px] border-b border-gray20">
            <tr>
              <th className="py-2 pt-2 pl-6 text-left">이름</th>
          ...
          <tbody>
            {sosListData.map((row, i) => (
              <tr
                key={i}
                className="border-b border-gray5 last:border-none hover:none transition "
              >
                <td className="py-4 pl-6 flex items-center gap-2 whitespace-nowrap max-w-[200px] truncate">
                  ...
                  <span className="text-[18px] ml-2">{row.name}</span>
                </td>
                ...
                <td className="px-2 text-[16px] text-gray90 text-center whitespace-nowrap truncate max-w-[120px]">
                  {row.requestDate}
                </td>
                <td className="px-2 text-[16px] text-gray90 text-center whitespace-nowrap truncate max-w-[120px]">
                  {row.completeDate}
                ...
                <td className="px-2 pr-6 text-right whitespace-nowrap">
                  <button
                    className="bg-white text-main900 text-[16px] font-semibold px-3 h-[40px] rounded-md border border-main900 "
                    onClick={() => navigate(`/main/sos-detail/${row.id}`)}
                  >
                    타임라인 추가
                  </button>
                </td>
